...
public class ActivityEditarPlayList extends AppCompatActivity implements infoPlayListEditarAsyncTask.DataFetchListener{
    ...
    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            ...
            if (ContextCompat.checkSelfPermission(ActivityEditarPlayList.this, Manifest.permission.READ_MEDIA_IMAGES) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(ActivityEditarPlayList.this, new String[]{Manifest.permission.READ_MEDIA_IMAGES}, REQUEST_CODE);
            } else {
            ...
            if (ContextCompat.checkSelfPermission(ActivityEditarPlayList.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
