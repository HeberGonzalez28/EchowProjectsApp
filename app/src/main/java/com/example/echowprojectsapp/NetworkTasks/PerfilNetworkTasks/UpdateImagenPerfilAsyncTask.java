...
public class UpdateImagenPerfilAsyncTask extends AsyncTask<String, Void, Void> {

    private final Context context;
    private final ProgressDialog progressDialog;

    public UpdateImagenPerfilAsyncTask(Context context) {
    ...
    protected Void doInBackground(String... params) {
        ...
        try {
            ...
            Log.d("UpdateImagenPerfilAsyncTask", "Response Code: " + responseCode);
